...
# Means have gone up (as expected) because some lower values have been eliminated
# Maxs have remained the same, some Mins have changecd for some (e.g. Buchanan Min went from 9.0 -> 22.0)
```
...
```{r}
# Change column values. This data set does not contain any string columns. Instead, replace 0 vote counts in HARRIS column (1) replace 0 values with NA, (2) replace 4's with 8, (3) replace 5's with 10
